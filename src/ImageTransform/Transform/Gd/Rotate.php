 ...
 * @author Javier Neyra
 */
class Rotate extends \ImageTransform\Transform
{
    ...
    protected function transform(\ImageTransform\Image $image)
    {
        ...
        {
            throw new \ImageTransform\Exception(sprintf('Cannot perform transform: %s. Your install of GD does not support imagerotate', get_class($this)));
