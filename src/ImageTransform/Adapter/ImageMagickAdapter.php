...
/**
 *
 * ImageTransform\ImageMagickAdapter class.
 *
...
class ImageMagickAdapter extends \ImageTransform\Adapter
{
    ...
    public function __construct()
    {
        ...
        {
            throw new \ImageTransform\Exception('The image processing library ImageMagick is not enabled. See PHP Manual for installation instructions.');
        }
